...
describe('Test PushWorker.closeNotifications()', function() {
  const swUtils = window.goog.SWHelper;
  const serviceWorkersFolder = '/test/browser-tests/push-worker/close-notifications/serviceworkers';
  ...
  it('should pass all get notification tests', function() {
    this.timeout(60000);
    const loadedSW = serviceWorkersFolder + '/close-notifications.js';
